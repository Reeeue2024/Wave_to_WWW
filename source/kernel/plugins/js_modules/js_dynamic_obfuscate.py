# [ Kernel ] Module - JS : js_dynamic_obfuscate.py
...
class JsDynamicObfuscate(BaseModule) :
    ...
    async def scan(self) :
        ...
        js_file_path = os.path.abspath(os.path.join(js_directory_path, "js_dynamic_obfuscate.js"))
        ...
        try :
            ...
            if self.module_run :
                ...
                # ( Run : True ) + ( Result : False )
                    ...
                    self.module_result_data["reason"] = "Not Exist Obfuscate Action."
...
if __name__ == "__main__" :
    ...
    if len(sys.argv) != 2 :
        ...
        print("How to Use : python3 js_dynamic_obfuscate.py < URL >")

        sys.exit(1)

    input_url = sys.argv[1]

    module_instance = JsDynamicObfuscate(input_url)
