# [ Kernel ] Module - JS : js_dynamic_hook.py
...
class JsDynamicHook(BaseModule) :
    ...
    async def scan(self) :
        ...
        js_file_path = os.path.abspath(os.path.join(js_directory_path, "js_dynamic_hook.js"))
...
if __name__ == "__main__" :
    ...
    if len(sys.argv) != 2 :
        ...
        print("How to Use : python3 js_dynamic_hook.py < URL >")

        sys.exit(1)

    input_url = sys.argv[1]

    module_instance = JsDynamicHook(input_url)
