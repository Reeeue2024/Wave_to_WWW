# [ Core ] Module - JS : js_external_dynamic.py ( True / False )
    ...
    def scan(self) :
        ...
        try :
            ...
            if flag :
                ...
                self.module_result_data["reason"] = "External Dynamic Exist."
                self.module_result_data["log_list"] = log_list

            else :

                self.module_result_flag = False
                self.module_result_data["reason"] = "External Dynamic Not Exist."
...
if __name__ == "__main__" :
    ...
    if len(sys.argv) != 2 :
        ...
        print("How to Use : python3 js_external_dynamic.py < URL >")
