...
export const categoryDescriptions = {
  ...
  Url: {
    en: "This section analyzes the structure and composition of the URL...",
    ko: "URL의 구조와 구성 요소를 분석합니다. URL 길이, 단축 URL, 과도한 서브도메인, 시각적으로 유사한 문자를 사용하는지 여부 등을 탐지합니다."
  },
  Html: {
    en: "This section examines the HTML source for suspicious tag usage...",
    ko: "HTML 소스 내에서 의심스러운 태그(`<form>`, `<iframe>`, `<meta refresh>` 등)의 사용 여부를 검사합니다."
  },
  JsStatic: {
    en: "This section analyzes the static JavaScript code embedded in the webpage...",
    ko: "웹페이지에 포함된 정적 JavaScript 코드 내 하드코딩된 리디렉션, 난독화된 코드, 외부 스크립트 등을 분석합니다."
  },
  JsDynamic: {
    en: "This section observes JavaScript behavior at runtime...",
...
export const moduleDescriptions = {
  Ai: {
    ...
    longDescription: {
      en: 'Our AI model analyzes 29 carefully selected features...',
  ...
  UrlShort: {
    ...
    longDescription: {
      en: 'Shortened URLs like those from bit.ly or tinyurl...',
  ...
  UrlSubDomain: {
    ...
    longDescription: {
      en: 'Phishing domains often use multiple subdomains...',
  ...
  UrlHttp: {
    ...
    longDescription: {
      en: 'Phishing sites often avoid HTTPS certificates...',
  ...
  UrlSsl: {
    ...
    longDescription: {
      en: 'Secure websites typically use verified SSL certificates...',
  ...
  UrlWhois: {
    ...
    longDescription: {
      en: 'WHOIS records provide domain ownership details...',
  ...
  UrlHomograph: {
    ...
    longDescription: {
      en: 'Phishers use homograph attacks to register domains like “gοοgle.com”...',
  ...
  HtmlForm: {
    ...
    longDescription: {
      en: 'Phishing pages often include login or payment forms...',
  ...
  HtmlIframe: {
    ...
    longDescription: {
      en: 'IFrames can embed external content invisibly...',
  ...
  HtmlJsUrl: {
    ...
    longDescription: {
      en: 'URLs starting with `javascript:` can execute arbitrary code...',
  ...
  HtmlLink: {
    ...
    longDescription: {
      en: 'Attackers may load external CSS/JS...',
  ...
  HtmlMetaRefresh: {
    ...
    longDescription: {
      en: 'Meta-refresh tags can automatically redirect users...',
  ...
  HtmlResourceUrl: {
    ...
    longDescription: {
      en: 'External resources can be used to track...',
  ...
  HtmlStyle: {
    ...
    longDescription: {
      en: 'Inline styles that obscure content...',
  ...
  JsStaticExternal: {
    ...
    longDescription: {
      en: 'Loading scripts from third-party domains...',
  ...
  JsStaticHook: {
    ...
    longDescription: {
      en: 'Event listeners like `onClick` or `onSubmit`...',
  ...
  JsStaticObfuscate: {
    ...
    longDescription: {
      en: 'Obfuscated JavaScript hides malicious intent...',
  ...
  JsStaticRedirect: {
    ...
    longDescription: {
      en: 'Hardcoded redirects using `window.location`...',
  ...
  JsStaticScript: {
    ...
    longDescription: {
      en: 'This module analyzes the usage of `<script>` tags...',
  ...
  JsDynamicDom: {
    ...
    longDescription: {
      en: 'Phishing pages may dynamically create or modify DOM elements...',
  ...
  JsDynamicExternal: {
    ...
    longDescription: {
      en: 'JavaScript code that injects `<script>` tags or uses `eval`...',
  ...
  JsDynamicHook: {
    ...
    longDescription: {
      en: 'Event listeners registered at runtime...',
  ...
  JsDynamicObfuscate: {
    ...
    longDescription: {
      en: 'Runtime obfuscation makes code harder to analyze...',
  ...
  JsDynamicRedirect: {
    ...
    longDescription: {
      en: 'JavaScript can redirect users post-load...',
