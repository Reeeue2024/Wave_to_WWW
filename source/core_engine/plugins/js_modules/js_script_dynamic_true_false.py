# [ Core ] Module - JS : js_script_dynamic.py ( True / False )
    ...
    def scan(self) :
        ...
        try :
            ...
            if flag :
                ...
                self.module_result_data["reason"] = "Script Dynamic Exist."
                self.module_result_data["log_list"] = log_list
            
            else :

                self.module_result_flag = False
                self.module_result_data["reason"] = "Script Dynamic Not Exist."
