# [ Core ] Module - JS : js_obfuscate_dynamic.py ( True / False )
    ...
    def scan(self) :
        ...
        try :
            ...
            if flag :
                ...
                self.module_result_data["reason"] = "Obfuscate Dynamic Exist."
                self.module_result_data["log_list"] = log_list
            
            else :
                self.module_result_flag = False
                self.module_result_data["reason"] = "Obfuscate Dynamic Not Exist."
